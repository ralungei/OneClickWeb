...
namespace UPM_IPS.RAARMAPMCWeberMDD
{
	...
	/// </summary>
	internal partial class RAARMAPMCWeberMDDDocView : RAARMAPMCWeberMDDDocViewBase
	{
		/// <summary>
		/// Constructs a new RAARMAPMCWeberMDDDocView.
		/// </summary>
		public RAARMAPMCWeberMDDDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class RAARMAPMCWeberMDDDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new RAARMAPMCWeberMDDDocView.
		/// </summary>
		protected RAARMAPMCWeberMDDDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			RAARMAPMCWeberMDDDocDataBase docData = this.DocData as RAARMAPMCWeberMDDDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for RAARMAPMCWeberMDDDocViewBase should be an RAARMAPMCWeberMDDDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.RAARMAPMCWeberMDDDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
