...
namespace UPM_IPS.RAARMAPMCWeberMDD
{
	...
	/// </summary>
	internal partial class RAARMAPMCWeberMDDDocData : RAARMAPMCWeberMDDDocDataBase
	{
		/// <summary>
		/// Constructs a new RAARMAPMCWeberMDDDocData.
		/// </summary>
		public RAARMAPMCWeberMDDDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a RAARMAPMCWeberMDD document in memory.
	/// </summary>
	internal abstract partial class RAARMAPMCWeberMDDDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new RAARMAPMCWeberMDDDocDataBase.
		/// </summary>
		protected RAARMAPMCWeberMDDDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDDomainModel));
		...
		protected override string SerializedModel
		{
			get
			{
				global::UPM_IPS.RAARMAPMCWeberMDD.WebERMDD modelRoot = this.RootElement as global::UPM_IPS.RAARMAPMCWeberMDD.WebERMDD;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
