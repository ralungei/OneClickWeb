...
namespace UPM_IPS.RAARMAPMCWeberMDD
{
	...
	/// </remarks>
	public partial class RAARMAPMCWeberMDDHelpKeywordHelper : RAARMAPMCWeberMDDHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new RAARMAPMCWeberMDDHelpKeywordHelper.
		/// </summary>
		protected RAARMAPMCWeberMDDHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the RAARMAPMCWeberMDDHelpKeywordHelper.
		/// </summary>
		public static RAARMAPMCWeberMDDHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class RAARMAPMCWeberMDDHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new RAARMAPMCWeberMDDHelpKeywordHelperBase.
		/// </summary>
		protected RAARMAPMCWeberMDDHelpKeywordHelperBase()
			: base() { }
