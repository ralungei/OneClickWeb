...
namespace UPM_IPS.RAARMAPMCWeberMDD
{
	...
	/// </remarks>
	public partial class RAARMAPMCWeberMDDToolboxHelper : RAARMAPMCWeberMDDToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new RAARMAPMCWeberMDDToolboxHelper.
		/// </summary>
		public RAARMAPMCWeberMDDToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class RAARMAPMCWeberMDDToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify RAARMAPMCWeberMDD toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "RAARMAPMCWeberMDD.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify RelAtrib connector tool.
		/// </summary>
		public const string RelAtribFilterString = "RelAtrib.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify RelIzq connector tool.
		/// </summary>
		public const string RelIzqFilterString = "RelIzq.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify RelDer connector tool.
		/// </summary>
		public const string RelDerFilterString = "RelDer.1.0";
		...
		/// <summary>
		/// Constructs a new RAARMAPMCWeberMDDToolboxHelperBase.
		/// </summary>
		protected RAARMAPMCWeberMDDToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDDomainModel.SingletonResourceManager.GetString("Modelo Entidad-RelacionToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::UPM_IPS.RAARMAPMCWeberMDD.RAARMAPMCWeberMDDDomainModel));
